...
import PTM from "src/components/sections/Documentation/Pertamina";
...
export const About = ({ isLightMode }) => {
  ...
  const Language = ["Bahasa (Native)", "English (Limited Working Proficiency)"];
  ...
  const [showPTM, setShowPTM] = useState(false);
    ...
    >
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4">
          {/* About Me Heading */}
          <h1
            className={`text-4xl font-bold mb-8 text-center bg-clip-text text-transparent animate-fade-in animate-gradient ${
              isLightMode
          ...
          {/* About Me Content */}
          <div
            className={`rounded-xl p-8 border hover:-translate-y-1 transition-all ${
              isLightMode
          ...
          >
            <div className="relative w-25 h-25 mx-auto mb-6">
              <div
                className={`absolute inset-0 bg-gradient-to-r rounded-[50%] blur-lg animate-gradient ${
                  isLightMode
                    ? "from-orange-400 via-orange-500 to-blue-400 shadow-[0_2px_8px_rgba(249,115,22,0.5)]"
                    : "from-blue-400 via-purple-600 to-purple-400  shadow-[0_0_30px_10px_rgba(59,130,246,0.5)]"
                }`}
              ></div>
              <img
                src={log}
            ...
            <p className="text-white mb-6 text-justify text-xs md:text-base">
              Hello! I’m Rinaldi Nurhardiansyah, an Industrial Engineer with
              expertise in supply chain optimization, logistics, inventory
              management, cost efficiency, and data-driven decision-making.
              Proficient in leveraging analytics tools (Excel, Python, SQL,
              Tableau, Power BI) to enhance operational efficiency, reduce
              costs, and improve inventory visibility. Skilled in collaborating
              with teams to align supply chain processes with organizational
              goals. Experienced in identifying inefficiencies, developing
              practical solutions, and improving workflow efficiency to ensure
              smooth operations. Let’s connect and explore how I can contribute
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-6 mt-10">
                  {[Language].map((skills, index) => (
                    <div
                      key={index}
                      className="rounded-xl hover:-translate-y-1 transition-all flex flex-col items-center justify-center border-white/10"
                    >
          ...
          <div className="flex flex-col gap-6 mt-8">
            ...
            <CollapsibleSection title="Education" isLightMode={isLightMode}>
              <div className="flex justify-between items-center mt-10">
                <h3
                  className={`font-semibold mb-3 text-sm md:text-base bg-clip-text text-transparent animate-gradient ${
                    isLightMode
                      ? "bg-gradient-to-r from-orange-400 via-orange-500 to-blue-400"
                      : "bg-gradient-to-r from-blue-400 via-blue-600 to-purple-500"
                  }`}
              ...
              <div className="flex justify-between">
                <h5 className="mb-2 text-xs md:text-base">
                  Grade: 3.72 / 4.00
                </h5>
            ...
            >
              ...
              <div>
                ...
                <div>
                  ...
                  <ul className="list-disc ml-5 text-xs md:text-base">
                    <li>
                      Led 29 assistants across 6 divisions, streamlining
                      practicum workflows and reducing task completion time by
                      40%.
                    </li>
                    <li>
                      Trained 21 assistants in operational protocols, achieving
                      a 90% efficiency improvement in practicum execution.
                    </li>
                  </ul>
                </div>
                ...
                <ul className="list-disc ml-5 text-xs md:text-base">
                  <li>
                    Delivered training for 600+ students across 5 industrial
                    engineering practicums, maintaining a 95% satisfaction rate.
                  </li>
                  <li>
                    Automated attendance and grading tracking using Excel,
                    cutting administrative workload by 25%.
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="list-disc ml-5 text-xs md:text-base">
                  <li>
                    Designed a check sheet for clearance activities, reducing
                    documentation errors by 30%.
                  </li>
                  <li>
                    Learned HACCP protocols and assisted the Powder Spray Dryer
                    (PSD) supervisor in conducting Root Cause Analysis (RCA) for
                    production delays.
                  </li>
                  <li>
                    Created Pareto diagrams to prioritize clearance activity
                    bottlenecks, improving compliance with safety standards by
                    15%.
                  </li>
                </ul>
            ...
            <CollapsibleSection title="Organization" isLightMode={isLightMode}>
              ...
              <div>
                ...
                <ul className="list-disc ml-5 text-xs md:text-base">
                  ...
                  <li>
                    Prepared and distributed food and beverages during the
                    event.
                  </li>
                </ul>

                <h3
                  className={`font-semibold mb-3 mt-5 text-sm md:text-base bg-clip-text text-transparent animate-gradient          
                  ${
                    isLightMode
                      ? "bg-gradient-to-r from-orange-400 via-orange-500 to-blue-400"
                      : "bg-gradient-to-r from-blue-400 via-blue-600 to-purple-500"
                ...
                >
                  6th Industrial Engineering Synergy (IES)
                </h3>
                <div className="flex justify-between items-center mb-2 text-xs md:text-base">
                ...
                <ul className="list-disc ml-5 text-xs md:text-base">
                  <li>
                    Created designs for posters, virtual backgrounds, and
                    certificates.
                  </li>
              ...
              <div>
                ...
                >
                  Industrial Engineering Accreditation Preparation Committee
                  (LAM TEKNIK)
                </h3>
                <div className="flex justify-between items-center mb-2 text-xs md:text-base">
                  <h5>Assistant</h5>
                ...
                <ul className="list-disc ml-5 text-xs md:text-base">
                  ...
                  <li>
                    Answered the assessor&apos;s questions and demonstrated the
                ...
                <ul className="list-disc ml-5 text-xs md:text-base">
                  <li>
                    Attended Environment, Health, and Safety training
                    activities.
                  </li>
                  <li>
                    Coordinated assistants to prepare necessary documents and
                    set up facilities.
                  </li>
                  <li>
                    Answered the assessor&apos;s questions and demonstrated the
              ...
              <div>
                ...
                <ul className="list-disc ml-5 text-xs md:text-base">
                  <li>
                    Created designs for nametag & backdrop and made a recap
                    video.
                  </li>
                  <li>
                    Prepared the event schedule and coordinated with the meeting
                    participants.
                  </li>
            ...
            <CollapsibleSection title="Volunteering" isLightMode={isLightMode}>
              ...
              <div>
                ...
                <ul className="list-disc ml-5 text-xs md:text-base">
                  <li>
                    Planned fundraising strategies & surveyed orphanages as
                    potential donation beneficiaries.
                  </li>
                  <li>Delivered presentations to potential donors.</li>
                  <li>
                    Coordinated and supervised over 40 assistants during the
                    charity event.
                  </li>
                </ul>
      ...
      {showAccreditation && (
        <Accreditation onClose={() => setShowAccreditation(false)} />
      )}
      ...
      {showPTM && <PTM onClose={() => setShowPTM(false)} />}
    </section>
  );
};
...
const CollapsibleSection = ({ title, children, isLightMode }) => {
  ...
  return (
    <div
      className={`p-6 rounded-xl border hover:-translate-y-1 transition-all ${
        isLightMode
          ? "border-orange-500/60 shadow-[0_2px_8px_rgba(249,115,22,0.2)] lg:border-white/10 lg:hover:border-orange-500/60 lg:hover:shadow-[0_2px_8px_rgba(249,115,22,0.2)]"
          : "border-blue-500/60 shadow-[0_2px_8px_rgba(59,130,246,0.2)] lg:border-white/10 lg:hover:border-blue-500/60 lg:hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)]"
      }`}
